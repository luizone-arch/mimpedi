...
class Tela_editar_Restaurante extends StatefulWidget{
  static Restaurante restaurante = Restaurante(culinaria: Tipo());

  @override
  State<StatefulWidget> createState() {
    return Tela_editar_RestauranteState();
  }
}
class Tela_editar_RestauranteState extends State<Tela_editar_Restaurante>{
  ...
  int? tipoCulinaria;
  int? codigo = Tela_editar_Restaurante.restaurante.codigo as int;


  void intState(){
    super.initState();
    carregarTipos();
    cdController.text = Tela_editar_Restaurante.restaurante.codigo.toString()!;
    nomeController.text = Tela_editar_Restaurante.restaurante.nomeRestaurante!;
    latitudeController.text = Tela_editar_Restaurante.restaurante.latitude.toString()!;
    longitudeController.text = Tela_editar_Restaurante.restaurante.longitude.toString()!;
    tipoCulinaria = Tela_editar_Restaurante.restaurante.culinaria?.codigo!;
    culinariaSelecionada = Tela_editar_Restaurante.restaurante.culinaria?.descricao!;
  }
